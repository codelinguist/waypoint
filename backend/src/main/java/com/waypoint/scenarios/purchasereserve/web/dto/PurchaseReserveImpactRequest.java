...
public record PurchaseReserveImpactRequest(
        ...
        @NotNull(message = "purchaseAmount must not be null")
        @DecimalMin(value = "0", message = "purchaseAmount must not be negative")
        @Digits(integer = 17, fraction = 2,
                message = "purchaseAmount must have at most 17 integer digits and 2 fraction digits")
        ...
        @NotNull(message = "minimumReserve must not be null")
        @DecimalMin(value = "0", message = "minimumReserve must not be negative")
        @Digits(integer = 17, fraction = 2,
                message = "minimumReserve must have at most 17 integer digits and 2 fraction digits")

...
public record DebtPrepaymentComparisonRequest(
        ...
        @NotNull(message = "immediatePrepayment must not be null")
        @DecimalMin(value = "0", message = "immediatePrepayment must not be negative")
        @Digits(integer = 17, fraction = 2, message = "immediatePrepayment must have at most 17 integer digits and 2 fraction digits")
